...
# from BrandrdXMusic import app   # Bu dosyada gerek yoksa kaldırabilirsiniz.
...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    # Güvenli süre hesapları
    played_sec = max(0, time_to_seconds(played))
    duration_sec = max(1, time_to_seconds(dur))  # 0'a bölmeyi engelle
    ...
    buttons = [
        ...
        [
 InlineKeyboardButton(
                text="❤️‍🔥ꜱᴀʜɪʙɪ❤️‍🔥", url=f"https://t.me/ragnarben"
            ),
            InlineKeyboardButton(
                text="🔮ᴅᴜʏᴜʀᴜ🔮", url=f"https://t.me/the_team_kumsal"
           ),
        ],
    ]
    return buttons
