...
def help_pannel(_, START: Union[bool, int] = None):
    """
    HELP menüsü için ana panel
    START True ise GERİ butonu, aksi halde KAPAT butonu gösterilir.
    """
...
def help_back_markup(_):
    """HELP içerisinden geri dönmek için buton"""
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text=_["BACK_BUTTON"],
                    callback_data="settingsback_helper",  # burada tek tip kullandık
                ),
            ]
        ]
    )
...
def private_help_panel(_):
    """
    Özel sohbetten /help çağrıldığında gösterilecek panel
    InlineKeyboardMarkup yerine liste döner (çağıran taraf uygulasın)
    """
    buttons = [
        [
            InlineKeyboardButton(
